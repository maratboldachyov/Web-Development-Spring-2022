...
export const products = [
  {
    ...
    link: 'https%3A%2F%2Fyoutu.be%2FpfEF17qfMXE',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    price: 1249,
    description:
      'Model Name MacBook Pro Brand Apple Specific Uses For Product Personal, Gaming, Business Screen Size 13.3 Inches Operating System Mac OS CPU Manufacturer Apple Graphics Card Description Integrated Color Silver Connectivity Technology Bluetooth, Wi-Fi, USB Hard Disk Size 256 GB',
    rating: '4.8 / 5',
  ...
  },
  {
    ...
    price: 135,
    description:
      'Brand Apple Ear Placement In Ear Color White Connectivity Technology Wireless, Apple H1 Chip Model Name AirPods',
    rating: '4.1 / 5',
  ...
  },
  {
    ...
    price: 159,
    description:
      'Brand Apple Color White Connectivity Technology Wireless Model Name AirPods Pro Form Factor In Ear',
    rating: '3.3 / 5',
